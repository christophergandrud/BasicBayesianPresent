---
title: "20 Minute Introduction to Bayesian Data Analysis"
...
4. **Repeat** when new data is available.
...
- [King, Tomz, and Wittenberg (2000)](http://gking.harvard.edu/files/gking/files/making.pdf) offer a middle ground for estimating **common sense uncertainty** with **post-estimation simulations**.
...
3. **Plot** some central interval of the results.
...
- [Zelig](http://gking.harvard.edu/zelig) (R)

- [MCMCpack](http://mcmcpack.berkeley.edu/) (R)

- [PyMC](http://pymc-devs.github.io/pymc/) (Python)
...
- All code available on [GitHub](https://github.com/christophergandrud/GreenBook).
...
- All code available on [GitHub](https://github.com/FGCH/FRTIndex).
...
- Use your programming language's version of [concatenate](http://en.wikipedia.org/wiki/Concatenation).
...
<a href="http://xkcd.com/974/"><img src="http://imgs.xkcd.com/comics/the_general_problem.png"></img></a>
...
- Relatively easy to set up (see [here](http://blog.yhathq.com/posts/r-in-the-cloud-part-1.html) and [my FRT code](https://github.com/FGCH/FRTIndex/blob/master/source/AmazonEC2Setup.sh)).
...
- [Intro to Bayesian methods using Python](http://camdavidsonpilon.github.io/Probabilistic-Programming-and-Bayesian-Methods-for-Hackers/).
